...
Usage:
    python scripts/lxc-marketplace/build_catalog.py                        # clone to temp dir
    python scripts/lxc-marketplace/build_catalog.py --repo-path /path/to   # use local clone
...
def main() -> None:
    ...
    # script lives in <project>/scripts/lxc-marketplace/
    project_root = Path(__file__).resolve().parent.parent.parent
    output_dir = Path(args.output_dir) if args.output_dir else project_root / "apps" / "lxc" / "data"
